...
function createOrUpdateContact(emailFieldValue, button) {
  var apiUrl = "https://pacific-lowlands-81394.herokuapp.com/createorupdatecontactseleniumwebdriverjavaboilerplate"; // get this from settings
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      window.location.href = "selenium-webdriver-java-boilerplate-dziekuje.html";
    },
