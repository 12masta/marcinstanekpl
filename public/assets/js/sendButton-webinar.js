$("#button-bottom").on("click", function(e) {
  addToWebinarNewsletter("#email-bottom", "#button-bottom");
});

$("#button-top").on("click", function(e) {
  addToWebinarNewsletter("#email-top", "#button-top");
});
...
function createOrUpdateContact(emailFieldValue, button) {
  var apiUrl = "https://pacific-lowlands-81394.herokuapp.com/createorupdatecontactseleniumwebinar"; // get this from settings
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      window.location.href = "webinar-dziekuje.html";
    },
